...
app.get('/allproduct', async (req,res)=>{
    let products = await Product.find({});
    // let addProduct = products.slice(1).slice(-8);
// console.log("newcollection added")
res.send(products);
})
...
app.get('/populerinwomen', async (req,res)=>{
    ...
    let populer_in_women = products.slice(1,5);
console.log("populerinwomen added")
...
//creating endpoint to remove product from card data
...
//creating end point for cartdata
